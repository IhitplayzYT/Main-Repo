...
`In a contract a 3rd party Individual called Exchange who acts as a middle man for preventing violation of a contract. Forwards have chance of Risk since they are OTC, Futures are done by an intermediatery service provider and regulated and standardized by SEBI.`
...
`HNI - High Network Individuals(Category of investors in a different pool,like IPO of over 2lakh makes you part of the HNI)`
...
- **Term Insurance** : Sum assured is only paid to the nominees of the death assured after death of person during term period.There is no maturity value on ending of the insurance.
...
#### Health Insurance:
Can be indemnity based where reimbursement upto a limit or fixed benefit based where fixed benefit to be paid regardless of loss expense. Cover expense for disease and injury treatment.
...
#### Property Insurance:
Based on indemnity basis.
- Householder insurance: Important since homes are one of the biggest investment made in many peoples lives.
- Loss against fire and perils of nature can also be insured against.
...
Liability Insurance is compulsory in India after the Motor vehicle act 1988.

##### Third-party/Liability Insurance:
Coverage that protects you from legal and financial liability caused to another person due to your vehicle/accident. It doesn't cover your expenses for damages/injury to you.

#### Travel Insurance:
- Medical expenses with cashless facility
- Personal Accident
- Loss of Baggage
- Loss of passport
- Travel delay
- Repatriation - Sending immigrants back
- Transportation of dead body.

#### Pensions/Annuity:
Fixed sum payed regularly to person after retirement from working life.
1. Immediate Annuity : Pay lump sum immediately and get payment for every month after next month. Basically immediately pay the large lump sum and your pension will start from now itself.
2. Deferred Annuity  : Regular payments to insurance companies until vestige age or option to pay single premium, company invest those funds to make interest to get payed after retirement. Meaning pay small sum during working life so that after retirement you can be paid back monthly.

Money from the accumulated annuity can be claimed in two ways:
1. Use full sum towards monthly annuity payments for the rest of your life
2. Take a lump sum of 1/3rd the sum and the remaining 2/3rd use for monthly annuity payments.Also called Partial Encashment

- Partial Encashment is called commutation and is tax free.
- Corpus Fund : Money given towards the pension contract.
...
Loss from multiple causes , but the most immediate(proximate) cause is used to determine the liability.
## Principal of Loss Minimization:
Insured must take reasonable steps to minimize the loss of damage or property.


# Payments

**Payment**: Transfer of monetary claim from the payer to another party that is acceptable to the payee
**Payee** : Person getting payed
**Payer** : Person paying the payee

### Properties of Money:
1. Issuer : Central bank issues the notes.
...
- Tendering money means paying money.

## Properties of legal tender:
- Acceptable by anyone no one can refuse
- Tangible
- Anonimity
- Accessibility
- Storage and security

- **Specie** : Money in the form of coins made of precious metals.

- Knights of Templar started issuing letters of credit in 1150 (Early form of banking)

## Timeline of money:

(3000 BC)Goods exchanged for other goods(Bartering)
				|
In between commodity like salt,cattle and grain were used.
				|
(700 BC)Minted coins were used
				|
(17th Century)Use of Bank Notes
				|
(1659) Drawn Notes(Cheques)
				|
(1979) Visa introduces Credit card
				|
(20th Century) Paying money without cash or cheque
				|
(21st Century)Escrow payments,One click payments,Cryptocurrency,Digital Wallets,etc.
...
National Automated Clearing House Association(NACHA) formed in 1974 to nationalize transactions among financial institutions.

2010 - Cheque truncation(Images of cheques instead of physical cheques)

**EFT(Electronic Fund Transfer)** : A generalized term to describe movement of electronic money.

Wire transfer : Quick,Irreversible, expensive,for both domestic and international and require more details , they are a type of EFT.

Telegraph used originally by Federal Reserve to transfer money.

Diner's club introduced the first credit card and txns became instantaneous.

Barclay Bank introduced the first ATM(Automated Teller Machine)

In 1994 Stanford Federal Credit Union first launched its online banking services for everyone.

In India ICICI started first online services for retail customers.
#### Escrow Account:
Temporary holding account managed by a neutral third party(escrow agent) that holds money or assets until certain conditions met in transaction. Once all conditions are met the escrow agent releases the funds back to the seller.

1983 - RFID(Radio Frequency Identification) was invented by Charles Walton

1995 - First contactless payment was done

1997 - Coca cola introduced mobile payments

2011 - First contactless payment app was made

2014-2015 - Apple pay and Samsung wallet.

Banking payments is the processes and systems used to transfer funds between parties in financial transaction.

Payment system enables financial transactions between businesses and customers. Payment Systems are needed and important for efficient and secure,liquidity and support economic growth, build trust and encourage more participants.
...
## 1. Payment Instruments
Consist of personalized devices,procedure agreed upon by end-users and payment service providers when electronic payment requests are requested.Method or tool  to make payment between payee and payer. 

Paper Payment Instruments are for payments which order is submitted to payment service provider in paper form.
### Classification of Payment Instruments:
1. Credit Payment Instruments : Credit cards,Loans,BNPL
2. Debit Payment Instruments : Debit cards,Prepaid Cards

## 2. Payment Schemes
Set of formal and standardized rules to enable transfer of value between end-user via electronic instrument managed by governing body.

# Working of Payment Schemes
##### 1. Initiation: Customer initiates payment through instrument like card,bank transfer,mobile wallet,etc.

##### 2. Authorization: Payment schemes validates if enough funds and if request is legitimate.

##### 3. Clearing: Processed by payment network(VISA,MasterCard) and funds are cleared between banks.
...
## 2. Payment Schemes/Systems
_The networks and platforms that process payments_
- **Card Networks**: Visa, Mastercard, RuPay, American Express
- **Digital Payment Systems**: UPI (Unified Payments Interface), IMPS, NEFT, RTGS
- **International Systems**: SWIFT, SEPA (Europe), Fedwire (US)
- **Mobile Payment Platforms**: Google Pay, PhonePe, Paytm (as UPI apps)
- **QR Code Systems**: Bharat QR, UPI QR
- **Wallet Systems**: Proprietary wallet networks
## 3. Payment Arrangements
_The organizational structures and relationships enabling payments_
- Visa/Mastercard/RuPay model with:
    - Cardholder (customer)
    - Issuer bank (customer's bank)
    - Acquirer bank (merchant's bank)
    - Card network (Visa/Mastercard)

- American Express or Discover model where the network also acts as issuer and acquirer

- Direct bank-to-bank payment agreements
- Correspondent banking relationships between two banks
- NPCI's UPI ecosystem (multiple banks, PSPs, and payment apps)
- Clearing house arrangements (multiple banks settling through a central entity)
**Payment Aggregator Arrangements**:
- Razorpay connecting merchants to multiple payment methods
- PayU arrangement with banks and payment networks
- Stripe's arrangements with card networks and banks
**Payment Gateway Arrangements**:
- CCAvenue, Paytm Payment Gateway
- Arrangements between merchants, gateway provider, and acquiring banks
...
# Single settlements Payments:
All transactions regardless of methods or network are settled on a single unified platform.
Advantages:
...
Acquirer/Acquiring Bank - Bank of the merchant
...
![[Pasted image 20251107164227.png]]

- Billdesk and Razor pay are payment gateways
...
POS(Point of sale) : The device which did the sale. eg : Credit card reader,ATM,etc.


![[Pasted image 20251107165902.png]]

Token - It is generated by Token Service Provider(like VISA,MASTERCARD ,etc) specific to each device this token also called DPAN.
...
![[Pasted image 20251107170334.png]]
![[Pasted image 20251107170355.png]]
![[Pasted image 20251107170414.png]]
![[Pasted image 20251107170431.png]]


Nominal Interest Rate :  Rate of interest advertised, doesn't take into consideration annual compounding frequency.

Effective Interest Rate : Actual Rate after accounting for compounding
...
- Guidelines on regulation of payment aggregators and payment gateways:
	...
	- All non-banks offering payment aggregators(PA) to seek authorization form RBI.
	- E-commerce platforms told to discontinue providing PA services.
	- Merchant side not save customers card and related details and regular checks to be carried out.
	- Use Card on File Tokenization(COFT) for online payments.

### Risk and Regulations in Banks

**Credit Risk** : When borrower or counterparty fail to meet contractual obligations

**Operational Risk** : Loss due to errors,interruptions or damages caused by people,system or processes.

**Market Risk**: Occur from bank's activities in Capital Markets

**Liquidity Risk** : Ability of bank to access cash to meet funding obligations

### Non-linear Risk:
- Geopolitical Risk
- Climate Change
- Cyber leap
- Digital assets - Digital assets are expanding with blockchain,Decentralized Finance(DeFi).
- Regulatory Expectations
- Customer Expectations
- Managing risk appetite
- Risk Travel from globalization and social media.

## Risk Management
Identify Risk -> Assess Risk -> Review Controls -> Control Risk
### Risk Response:
...
- Risk Culture
- Outsourcing Risks
- Bank specific risk management process
- Regulators can't monitor daily
- Non-linear risks are hard to predict
- Banks in reactive mode
- Fraudster clever then regulators.
