...
Node *add_beggining_d(Node **head, void *data, int type) {
...
Node *add_end_d(Node **head, void *data, int type) {
  Node *node = (Node *)malloc(sizeof(Node));
  if (node == NULL) {
    return NULL;
  }
...
void insert_at_d(Node **head, void *data, int type, int index) {
  if (list_length(*head) <= index) {
    add_end_d(head, data, type);
  }
  if (*head == NULL || index == 0) {
    add_beggining_d(head, data, type);
    return;
  }
  Node *cur = *head;
...
void insert_after_d(Node **head, void *data, int flag_s, void *data_compare) {
  Node *node = (Node *)malloc(sizeof(Node));
  if (node == NULL) {
    return;
  }
...
void delete_at_d(Node **head, int index) {
...
void delete_elem_d(Node **head, void *data) {
  if (*head == NULL) {
    return;
  }
  Node *cur = *head;
...
void insert_before_d(Node **head, void *data, int flag_s, void *data_compare) {
  Node *node = (Node *)malloc(sizeof(Node));
  int found = 1;
  if (node == NULL) {
    return;
